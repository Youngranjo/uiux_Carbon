<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvBreadcrumbSkeletonItem>.
  ...
  Usage:
    import BreadcrumbSkeletonItem from './components/BreadcrumbSkeletonItem.vue';
    <BreadcrumbSkeletonItem>...</BreadcrumbSkeletonItem>
-->
<script>
import { CvBreadcrumbSkeletonItem } from '@carbon/vue';
export default CvBreadcrumbSkeletonItem;
</script>
