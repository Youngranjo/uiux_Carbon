<!--
  Vue wrapper for Carbon's official Web Component <cds-heading>.
  ...
  Usage:
    <script setup> import Heading from './components/Heading.vue' </script>
...
<template>
  <cds-heading v-bind="$attrs"><slot /></cds-heading>
</template>
