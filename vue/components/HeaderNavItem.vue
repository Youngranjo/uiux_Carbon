<!--
  Vue wrapper for Carbon's official Web Component <cds-header-nav-item>.
  ...
  Attributes (see custom-elements.json for the full list):
      ...
      aria-current (string) — indicates that this element represents the current item
      role (string) — As child of <ul>, this element must have role of listitem

  Usage:
    <script setup> import HeaderNavItem from './components/HeaderNavItem.vue' </script>
    <HeaderNavItem>Example</HeaderNavItem>
-->
<script setup>
...
<template>
  <cds-header-nav-item v-bind="$attrs"><slot /></cds-header-nav-item>
</template>
