<!--
  Vue wrapper for Carbon's official Web Component <cds-fluid-number-input>.
  ...
  Usage:
    <script setup> import FluidNumberInput from './components/FluidNumberInput.vue' </script>
    <FluidNumberInput>Example</FluidNumberInput>
-->
<script setup>
...
<template>
  <cds-fluid-number-input v-bind="$attrs"><slot /></cds-fluid-number-input>
</template>
