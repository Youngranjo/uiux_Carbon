<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvSwitcherItemLink>.
  ...
  Usage:
    import SwitcherItemLink from './components/SwitcherItemLink.vue';
    <SwitcherItemLink>...</SwitcherItemLink>
-->
<script>
import { CvSwitcherItemLink } from '@carbon/vue';
export default CvSwitcherItemLink;
</script>
