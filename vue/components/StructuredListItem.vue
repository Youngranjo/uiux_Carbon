<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvStructuredListItem>.
  ...
  Usage:
    import StructuredListItem from './components/StructuredListItem.vue';
    <StructuredListItem>...</StructuredListItem>
-->
<script>
import { CvStructuredListItem } from '@carbon/vue';
export default CvStructuredListItem;
</script>
