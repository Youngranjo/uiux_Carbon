<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvDataTableSkeleton>.
...
-->
<script>
import { CvDataTableSkeleton } from '@carbon/vue';
export default CvDataTableSkeleton;
</script>
