<!--
  Vue wrapper for Carbon's official Web Component <cds-structured-list-header-cell>.
  ...
  Usage:
    <script setup> import StructuredListHeaderCell from './components/StructuredListHeaderCell.vue' </script>
    <StructuredListHeaderCell>Example</StructuredListHeaderCell>
-->
<script setup>
...
<template>
  <cds-structured-list-header-cell v-bind="$attrs"><slot /></cds-structured-list-header-cell>
</template>
