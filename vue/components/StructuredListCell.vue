<!--
  Vue wrapper for Carbon's official Web Component <cds-structured-list-cell>.
  ...
  Usage:
    <script setup> import StructuredListCell from './components/StructuredListCell.vue' </script>
    <StructuredListCell>Example</StructuredListCell>
-->
<script setup>
...
<template>
  <cds-structured-list-cell v-bind="$attrs"><slot /></cds-structured-list-cell>
</template>
