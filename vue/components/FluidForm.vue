<!--
  Vue wrapper for Carbon's official Web Component <cds-fluid-form>.
  ...
  Usage:
    <script setup> import FluidForm from './components/FluidForm.vue' </script>
    <FluidForm>Example</FluidForm>
-->
<script setup>
...
<template>
  <cds-fluid-form v-bind="$attrs"><slot /></cds-fluid-form>
</template>
