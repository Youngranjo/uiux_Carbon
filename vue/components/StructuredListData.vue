<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvStructuredListData>.
  ...
  Usage:
    import StructuredListData from './components/StructuredListData.vue';
    <StructuredListData>...</StructuredListData>
-->
<script>
import { CvStructuredListData } from '@carbon/vue';
export default CvStructuredListData;
</script>
