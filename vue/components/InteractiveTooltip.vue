<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvInteractiveTooltip>.
...
-->
<script>
import { CvInteractiveTooltip } from '@carbon/vue';
export default CvInteractiveTooltip;
</script>
