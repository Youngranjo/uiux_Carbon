<!--
  Vue wrapper for Carbon's official Web Component <cds-file-uploader-skeleton>.
  ...
  Usage:
    <script setup> import FileUploaderSkeleton from './components/FileUploaderSkeleton.vue' </script>
    <FileUploaderSkeleton>Example</FileUploaderSkeleton>
-->
<script setup>
...
<template>
  <cds-file-uploader-skeleton v-bind="$attrs"><slot /></cds-file-uploader-skeleton>
</template>
