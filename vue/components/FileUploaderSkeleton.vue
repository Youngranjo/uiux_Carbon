<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvFileUploaderSkeleton>.
  ...
  Usage:
    import FileUploaderSkeleton from './components/FileUploaderSkeleton.vue';
    <FileUploaderSkeleton>...</FileUploaderSkeleton>
-->
<script>
import { CvFileUploaderSkeleton } from '@carbon/vue';
export default CvFileUploaderSkeleton;
</script>
