<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvDatePickerSkeleton>.
  ...
  Usage:
    import DatePickerSkeleton from './components/DatePickerSkeleton.vue';
    <DatePickerSkeleton>...</DatePickerSkeleton>
-->
<script>
import { CvDatePickerSkeleton } from '@carbon/vue';
export default CvDatePickerSkeleton;
</script>
