<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvStructuredListHeading>.
  ...
  Usage:
    import StructuredListHeading from './components/StructuredListHeading.vue';
    <StructuredListHeading>...</StructuredListHeading>
-->
<script>
import { CvStructuredListHeading } from '@carbon/vue';
export default CvStructuredListHeading;
</script>
