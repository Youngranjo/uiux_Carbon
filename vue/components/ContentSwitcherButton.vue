<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvContentSwitcherButton>.
  ...
  Usage:
    import ContentSwitcherButton from './components/ContentSwitcherButton.vue';
    <ContentSwitcherButton>...</ContentSwitcherButton>
-->
<script>
import { CvContentSwitcherButton } from '@carbon/vue';
export default CvContentSwitcherButton;
</script>
