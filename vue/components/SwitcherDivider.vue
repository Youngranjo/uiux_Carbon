<!--
  Vue wrapper for Carbon's official Web Component <cds-switcher-divider>.
  ...
  Usage:
    <script setup> import SwitcherDivider from './components/SwitcherDivider.vue' </script>
    <SwitcherDivider>Example</SwitcherDivider>
-->
<script setup>
...
<template>
  <cds-switcher-divider v-bind="$attrs"><slot /></cds-switcher-divider>
</template>
