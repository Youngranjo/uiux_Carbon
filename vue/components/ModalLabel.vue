<!--
  Vue wrapper for Carbon's official Web Component <cds-modal-label>.
  ...
  Attributes (see custom-elements.json for the full list):
      id (string) — The unique identifier for this label element

  Usage:
    <script setup> import ModalLabel from './components/ModalLabel.vue' </script>
    <ModalLabel>Example</ModalLabel>
-->
<script setup>
...
<template>
  <cds-modal-label v-bind="$attrs"><slot /></cds-modal-label>
</template>
