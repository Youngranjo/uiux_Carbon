<!--
  Vue wrapper for Carbon's official Web Component <cds-fluid-combo-box-skeleton>.
  ...
  Usage:
    <script setup> import FluidComboBoxSkeleton from './components/FluidComboBoxSkeleton.vue' </script>
    <FluidComboBoxSkeleton>Example</FluidComboBoxSkeleton>
-->
<script setup>
...
<template>
  <cds-fluid-combo-box-skeleton v-bind="$attrs"><slot /></cds-fluid-combo-box-skeleton>
</template>
