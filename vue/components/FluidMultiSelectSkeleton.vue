<!--
  Vue wrapper for Carbon's official Web Component <cds-fluid-multi-select-skeleton>.
  ...
  Usage:
    <script setup> import FluidMultiSelectSkeleton from './components/FluidMultiSelectSkeleton.vue' </script>
    <FluidMultiSelectSkeleton>Example</FluidMultiSelectSkeleton>
-->
<script setup>
...
<template>
  <cds-fluid-multi-select-skeleton v-bind="$attrs"><slot /></cds-fluid-multi-select-skeleton>
</template>
