<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvSliderSkeleton>.
  ...
  Usage:
    import SliderSkeleton from './components/SliderSkeleton.vue';
    <SliderSkeleton>...</SliderSkeleton>
-->
<script>
import { CvSliderSkeleton } from '@carbon/vue';
export default CvSliderSkeleton;
</script>
