<!--
  Vue wrapper for Carbon's official Web Component <cds-table-toolbar-content>.
  ...
  Attributes (see custom-elements.json for the full list):
      has-batch-actions (boolean) — `true` if this batch actions bar is active.
      size (string) — Table toolbar contents size

  Usage:
    <script setup> import TableToolbarContent from './components/TableToolbarContent.vue' </script>
    <TableToolbarContent>Example</TableToolbarContent>
-->
<script setup>
...
<template>
  <cds-table-toolbar-content v-bind="$attrs"><slot /></cds-table-toolbar-content>
</template>
