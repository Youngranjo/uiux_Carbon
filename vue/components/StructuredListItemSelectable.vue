<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvStructuredListItemSelectable>.
  ...
  Usage:
    import StructuredListItemSelectable from './components/StructuredListItemSelectable.vue';
    <StructuredListItemSelectable>...</StructuredListItemSelectable>
-->
<script>
import { CvStructuredListItemSelectable } from '@carbon/vue';
export default CvStructuredListItemSelectable;
</script>
