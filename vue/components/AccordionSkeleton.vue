<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvAccordionSkeleton>.
  ...
  Usage:
    import AccordionSkeleton from './components/AccordionSkeleton.vue';
    <AccordionSkeleton>...</AccordionSkeleton>
-->
<script>
import { CvAccordionSkeleton } from '@carbon/vue';
export default CvAccordionSkeleton;
</script>
