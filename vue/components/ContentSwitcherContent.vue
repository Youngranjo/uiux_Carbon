<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvContentSwitcherContent>.
  ...
  Usage:
    import ContentSwitcherContent from './components/ContentSwitcherContent.vue';
    <ContentSwitcherContent>...</ContentSwitcherContent>
-->
<script>
import { CvContentSwitcherContent } from '@carbon/vue';
export default CvContentSwitcherContent;
</script>
