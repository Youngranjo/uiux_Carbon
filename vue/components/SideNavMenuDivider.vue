<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvSideNavMenuDivider>.
  ...
  Usage:
    import SideNavMenuDivider from './components/SideNavMenuDivider.vue';
    <SideNavMenuDivider>...</SideNavMenuDivider>
-->
<script>
import { CvSideNavMenuDivider } from '@carbon/vue';
export default CvSideNavMenuDivider;
</script>
