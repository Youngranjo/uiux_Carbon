<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvStructuredListItemStandard>.
  ...
  Usage:
    import StructuredListItemStandard from './components/StructuredListItemStandard.vue';
    <StructuredListItemStandard>...</StructuredListItemStandard>
-->
<script>
import { CvStructuredListItemStandard } from '@carbon/vue';
export default CvStructuredListItemStandard;
</script>
