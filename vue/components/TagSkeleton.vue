<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvTagSkeleton>.
  ...
  Usage:
    import TagSkeleton from './components/TagSkeleton.vue';
    <TagSkeleton>...</TagSkeleton>
-->
<script>
import { CvTagSkeleton } from '@carbon/vue';
export default CvTagSkeleton;
</script>
