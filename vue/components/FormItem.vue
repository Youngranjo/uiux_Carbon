<!--
  Vue wrapper for Carbon's official Web Component <cds-form-item>.
  ...
  Usage:
    <script setup> import FormItem from './components/FormItem.vue' </script>
...
<template>
  <cds-form-item v-bind="$attrs"><slot /></cds-form-item>
</template>
