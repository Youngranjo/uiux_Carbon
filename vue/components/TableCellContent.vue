<!--
  Vue wrapper for Carbon's official Web Component <cds-table-cell-content>.
  ...
  Usage:
    <script setup> import TableCellContent from './components/TableCellContent.vue' </script>
...
<template>
  <cds-table-cell-content v-bind="$attrs"><slot /></cds-table-cell-content>
</template>
