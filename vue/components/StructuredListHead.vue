<!--
  Vue wrapper for Carbon's official Web Component <cds-structured-list-head>.
  ...
  Usage:
    <script setup> import StructuredListHead from './components/StructuredListHead.vue' </script>
    <StructuredListHead>Example</StructuredListHead>
-->
<script setup>
...
<template>
  <cds-structured-list-head v-bind="$attrs"><slot /></cds-structured-list-head>
</template>
