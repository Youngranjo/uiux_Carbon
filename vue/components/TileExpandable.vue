<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvTileExpandable>.
  ...
  Usage:
    import TileExpandable from './components/TileExpandable.vue';
    <TileExpandable>...</TileExpandable>
-->
<script>
import { CvTileExpandable } from '@carbon/vue';
export default CvTileExpandable;
</script>
