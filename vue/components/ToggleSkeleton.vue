<!--
  Vue wrapper for Carbon's official Web Component <cds-toggle-skeleton>.
  ...
  Usage:
    <script setup> import ToggleSkeleton from './components/ToggleSkeleton.vue' </script>
    <ToggleSkeleton>Example</ToggleSkeleton>
-->
<script setup>
...
<template>
  <cds-toggle-skeleton v-bind="$attrs"><slot /></cds-toggle-skeleton>
</template>
