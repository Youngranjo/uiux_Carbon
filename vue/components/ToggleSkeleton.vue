<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvToggleSkeleton>.
  ...
  Usage:
    import ToggleSkeleton from './components/ToggleSkeleton.vue';
    <ToggleSkeleton>...</ToggleSkeleton>
-->
<script>
import { CvToggleSkeleton } from '@carbon/vue';
export default CvToggleSkeleton;
</script>
