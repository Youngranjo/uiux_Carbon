<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvDefinitionTooltip>.
  ...
  Usage:
    import DefinitionTooltip from './components/DefinitionTooltip.vue';
    <DefinitionTooltip>...</DefinitionTooltip>
-->
<script>
import { CvDefinitionTooltip } from '@carbon/vue';
export default CvDefinitionTooltip;
</script>
