<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvTextAreaSkeleton>.
  ...
  Usage:
    import TextAreaSkeleton from './components/TextAreaSkeleton.vue';
    <TextAreaSkeleton>...</TextAreaSkeleton>
-->
<script>
import { CvTextAreaSkeleton } from '@carbon/vue';
export default CvTextAreaSkeleton;
</script>
