<!--
  Vue wrapper for Carbon's official Web Component <cds-modal-header>.
  ...
  Usage:
    <script setup> import ModalHeader from './components/ModalHeader.vue' </script>
...
<template>
  <cds-modal-header v-bind="$attrs"><slot /></cds-modal-header>
</template>
