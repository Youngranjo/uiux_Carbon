<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvTileStandard>.
  ...
  Usage:
    import TileStandard from './components/TileStandard.vue';
    <TileStandard>...</TileStandard>
-->
<script>
import { CvTileStandard } from '@carbon/vue';
export default CvTileStandard;
</script>
