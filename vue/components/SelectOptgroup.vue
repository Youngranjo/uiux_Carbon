<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvSelectOptgroup>.
  ...
  Usage:
    import SelectOptgroup from './components/SelectOptgroup.vue';
    <SelectOptgroup>...</SelectOptgroup>
-->
<script>
import { CvSelectOptgroup } from '@carbon/vue';
export default CvSelectOptgroup;
</script>
