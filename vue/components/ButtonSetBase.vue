<!--
  Vue wrapper for Carbon's official Web Component <cds-button-set-base>.
  ...
  Usage:
    <script setup> import ButtonSetBase from './components/ButtonSetBase.vue' </script>
    <ButtonSetBase>Example</ButtonSetBase>
-->
<script setup>
...
<template>
  <cds-button-set-base v-bind="$attrs"><slot /></cds-button-set-base>
</template>
