<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvButtonSkeleton>.
  ...
  Usage:
    import ButtonSkeleton from './components/ButtonSkeleton.vue';
    <ButtonSkeleton>...</ButtonSkeleton>
-->
<script>
import { CvButtonSkeleton } from '@carbon/vue';
export default CvButtonSkeleton;
</script>
