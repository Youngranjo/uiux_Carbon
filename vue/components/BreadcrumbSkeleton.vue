<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvBreadcrumbSkeleton>.
  ...
  Usage:
    import BreadcrumbSkeleton from './components/BreadcrumbSkeleton.vue';
    <BreadcrumbSkeleton>...</BreadcrumbSkeleton>
-->
<script>
import { CvBreadcrumbSkeleton } from '@carbon/vue';
export default CvBreadcrumbSkeleton;
</script>
