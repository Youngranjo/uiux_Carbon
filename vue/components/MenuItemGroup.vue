<!--
  Vue wrapper for Carbon's official Web Component <cds-menu-item-group>.
  ...
  Usage:
    <script setup> import MenuItemGroup from './components/MenuItemGroup.vue' </script>
    <MenuItemGroup>Example</MenuItemGroup>
-->
<script setup>
...
<template>
  <cds-menu-item-group v-bind="$attrs"><slot /></cds-menu-item-group>
</template>
