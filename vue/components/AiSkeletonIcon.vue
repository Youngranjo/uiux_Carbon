<!--
  Vue wrapper for Carbon's official Web Component <cds-ai-skeleton-icon>.
  ...
  Attributes (see custom-elements.json for the full list):
      custom-styles (string) — Custom styles to apply to skeleton icon

  Usage:
    <script setup> import AiSkeletonIcon from './components/AiSkeletonIcon.vue' </script>
    <AiSkeletonIcon>Example</AiSkeletonIcon>
-->
<script setup>
...
<template>
  <cds-ai-skeleton-icon v-bind="$attrs"><slot /></cds-ai-skeleton-icon>
</template>
