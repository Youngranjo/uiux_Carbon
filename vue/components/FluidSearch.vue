<!--
  Vue wrapper for Carbon's official Web Component <cds-fluid-search>.
  ...
  Usage:
    <script setup> import FluidSearch from './components/FluidSearch.vue' </script>
    <FluidSearch>Example</FluidSearch>
-->
<script setup>
...
<template>
  <cds-fluid-search v-bind="$attrs"><slot /></cds-fluid-search>
</template>
