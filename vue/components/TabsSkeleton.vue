<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvTabsSkeleton>.
  ...
  Usage:
    import TabsSkeleton from './components/TabsSkeleton.vue';
    <TabsSkeleton>...</TabsSkeleton>
-->
<script>
import { CvTabsSkeleton } from '@carbon/vue';
export default CvTabsSkeleton;
</script>
