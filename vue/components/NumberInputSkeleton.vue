<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvNumberInputSkeleton>.
  ...
  Usage:
    import NumberInputSkeleton from './components/NumberInputSkeleton.vue';
    <NumberInputSkeleton>...</NumberInputSkeleton>
-->
<script>
import { CvNumberInputSkeleton } from '@carbon/vue';
export default CvNumberInputSkeleton;
</script>
