<!--
  Vue wrapper for Carbon's official Web Component <cds-dialog-header>.
  ...
  Usage:
    <script setup> import DialogHeader from './components/DialogHeader.vue' </script>
    <DialogHeader>Example</DialogHeader>
-->
<script setup>
...
<template>
  <cds-dialog-header v-bind="$attrs"><slot /></cds-dialog-header>
</template>
