<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvDataTableHeading>.
  ...
  Usage:
    import DataTableHeading from './components/DataTableHeading.vue';
    <DataTableHeading>...</DataTableHeading>
-->
<script>
import { CvDataTableHeading } from '@carbon/vue';
export default CvDataTableHeading;
</script>
