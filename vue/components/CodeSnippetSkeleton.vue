<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvCodeSnippetSkeleton>.
  ...
  Usage:
    import CodeSnippetSkeleton from './components/CodeSnippetSkeleton.vue';
    <CodeSnippetSkeleton>...</CodeSnippetSkeleton>
-->
<script>
import { CvCodeSnippetSkeleton } from '@carbon/vue';
export default CvCodeSnippetSkeleton;
</script>
