<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvProgressSkeleton>.
  ...
  Usage:
    import ProgressSkeleton from './components/ProgressSkeleton.vue';
    <ProgressSkeleton>...</ProgressSkeleton>
-->
<script>
import { CvProgressSkeleton } from '@carbon/vue';
export default CvProgressSkeleton;
</script>
