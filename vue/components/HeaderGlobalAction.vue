<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvHeaderGlobalAction>.
  ...
  Usage:
    import HeaderGlobalAction from './components/HeaderGlobalAction.vue';
    <HeaderGlobalAction>...</HeaderGlobalAction>
-->
<script>
import { CvHeaderGlobalAction } from '@carbon/vue';
export default CvHeaderGlobalAction;
</script>
