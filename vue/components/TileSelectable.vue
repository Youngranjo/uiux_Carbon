<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvTileSelectable>.
  ...
  Usage:
    import TileSelectable from './components/TileSelectable.vue';
    <TileSelectable>...</TileSelectable>
-->
<script>
import { CvTileSelectable } from '@carbon/vue';
export default CvTileSelectable;
</script>
