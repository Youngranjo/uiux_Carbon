<!--
  Vue wrapper for Carbon's official Web Component <cds-fluid-search-skeleton>.
  ...
  Attributes (see custom-elements.json for the full list):
      size (SEARCH_SIZE | undefined) — The search skeleton size.

  Usage:
    <script setup> import FluidSearchSkeleton from './components/FluidSearchSkeleton.vue' </script>
    <FluidSearchSkeleton>Example</FluidSearchSkeleton>
-->
<script setup>
...
<template>
  <cds-fluid-search-skeleton v-bind="$attrs"><slot /></cds-fluid-search-skeleton>
</template>
