<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvFileUploaderItem>.
  ...
  Usage:
    import FileUploaderItem from './components/FileUploaderItem.vue';
    <FileUploaderItem>...</FileUploaderItem>
-->
<script>
import { CvFileUploaderItem } from '@carbon/vue';
export default CvFileUploaderItem;
</script>
