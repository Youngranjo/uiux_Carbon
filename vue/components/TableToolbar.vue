<!--
  Vue wrapper for Carbon's official Web Component <cds-table-toolbar>.
  ...
  Attributes (see custom-elements.json for the full list):
      size (string) — Toolbar size

  Usage:
    <script setup> import TableToolbar from './components/TableToolbar.vue' </script>
    <TableToolbar>Example</TableToolbar>
-->
<script setup>
...
<template>
  <cds-table-toolbar v-bind="$attrs"><slot /></cds-table-toolbar>
</template>
