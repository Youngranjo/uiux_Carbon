<!--
  Vue wrapper for Carbon's official Web Component <cds-structured-list-body>.
  ...
  Usage:
    <script setup> import StructuredListBody from './components/StructuredListBody.vue' </script>
    <StructuredListBody>Example</StructuredListBody>
-->
<script setup>
...
<template>
  <cds-structured-list-body v-bind="$attrs"><slot /></cds-structured-list-body>
</template>
