<!--
  Vue wrapper for Carbon's official Web Component <cds-menu-item-divider>.
  ...
  Usage:
    <script setup> import MenuItemDivider from './components/MenuItemDivider.vue' </script>
    <MenuItemDivider>Example</MenuItemDivider>
-->
<script setup>
...
<template>
  <cds-menu-item-divider v-bind="$attrs"><slot /></cds-menu-item-divider>
</template>
