<!--
  Vue wrapper for Carbon's official Web Component <cds-contained-list-description>.
  ...
  Usage:
    <script setup> import ContainedListDescription from './components/ContainedListDescription.vue' </script>
    <ContainedListDescription>Example</ContainedListDescription>
-->
<script setup>
...
<template>
  <cds-contained-list-description v-bind="$attrs"><slot /></cds-contained-list-description>
</template>
