<!--
  Vue wrapper for Carbon's official Web Component <cds-side-nav-items>.
  ...
  Usage:
    <script setup> import SideNavItems from './components/SideNavItems.vue' </script>
    <SideNavItems>Example</SideNavItems>
-->
<script setup>
...
<template>
  <cds-side-nav-items v-bind="$attrs"><slot /></cds-side-nav-items>
</template>
