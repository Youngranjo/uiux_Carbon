<!--
  Vue wrapper for Carbon's official Web Component <cds-column-hang>.
  ...
  Usage:
    <script setup> import ColumnHang from './components/ColumnHang.vue' </script>
    <ColumnHang>Example</ColumnHang>
-->
<script setup>
...
<template>
  <cds-column-hang v-bind="$attrs"><slot /></cds-column-hang>
</template>
