<!--
  Vue wrapper for Carbon's official Web Component <cds-breadcrumb-item>.
  ...
  Usage:
    <script setup> import BreadcrumbItem from './components/BreadcrumbItem.vue' </script>
...
<template>
  <cds-breadcrumb-item v-bind="$attrs"><slot /></cds-breadcrumb-item>
</template>
