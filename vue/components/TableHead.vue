<!--
  Vue wrapper for Carbon's official Web Component <cds-table-head>.
  ...
  Usage:
    <script setup> import TableHead from './components/TableHead.vue' </script>
...
<template>
  <cds-table-head v-bind="$attrs"><slot /></cds-table-head>
</template>
