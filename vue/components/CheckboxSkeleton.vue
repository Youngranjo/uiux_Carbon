<!--
  Vue wrapper for the REAL, official @carbon/vue component <CvCheckboxSkeleton>.
  ...
  Usage:
    import CheckboxSkeleton from './components/CheckboxSkeleton.vue';
    <CheckboxSkeleton>...</CheckboxSkeleton>
-->
<script>
import { CvCheckboxSkeleton } from '@carbon/vue';
export default CvCheckboxSkeleton;
</script>
